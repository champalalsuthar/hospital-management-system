        ...
        <PrivateRoutelogin>
            <section className="bg-gray-300 ">
                ...
                <div class="lg:grid lg:min-h-screen lg:grid-cols-12 text-center">
                    ...
                    >
                        <div class="max-w-xl lg:max-w-3xl  mt-16">
                            ...
                            <form onSubmit={handleSubmit} className="mt-8 grid grid-cols-6 gap-6 ">
                                ...
                                <div className="col-span-6 w-2/3 mx-auto">
                                    <p className="text-sm text-gray-500">
                                        By loging an account, you agree to our
                                ...
                                <div className="col-span-6  w-2/3 mx-auto gap-4">
                                    <button
                                        type="submit"
                                    ...
                                    <div className="m-4 text-[13px] text-gray-500  text-violet-900 font-semibold">
                                        New User?
                                        <a href="/signup" className="text-red-700 underline  font-bold mx-2">
                                            SignUp
                                        </a>
                                    </div>
                                </div>
