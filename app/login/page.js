...
import PrivateRoutelogin from '@/components/customprivateroute/PrivateRoutelogin';
...
const Page = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            // Send form data to the server API route
            ...
            if (response.status === 404) {
                ...
                // Form data sent successfully, you can handle the response here
                const responseData = await response.json();
                // console.log(responseData);
                // console.log("token" + responseData.token);
                localStorage.setItem("token", responseData.token);
                const data = JSON.parse(responseData.myuser);
                // console.log("logeduserdata" + responseData.myuser);
    ...
    return (
        ...
        <section className="bg-gray-300 ">
            ...
            <div class="lg:grid lg:min-h-screen lg:grid-cols-12 text-center">
                        ...
                        <form onSubmit={handleSubmit} className="mt-8 grid grid-cols-6 gap-6 ">
                            ...
                            <div class="col-span-6">
                                ...
                                <input
                                    ...
                                    class="mt-1 p-2  w-full rounded-md border-slate-400 border-2 outline-none bg-white text-sm text-gray-700 shadow-lg"
                                />
                            </div>
...
{/* <div class="col-span-6">
                                <label htmlFor="MarketingAccept" class="flex gap-4">
                                    <input
                                        type="checkbox"
                                        id="MarketingAccept"
                                        ...
                                        onChange={handleChange}
                                        class="size-5 rounded-md border-slate-400 border-2 outline-none bg-white shadow-lg"
                                    />

                                    <span class="text-sm text-gray-700">
                                        I'm agree to
                                        <a href="/terms-and-conditions" class="text-gray-700 underline"> terms and conditions </a>
                                        and
