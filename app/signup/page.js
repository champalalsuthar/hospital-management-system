                        ...
                        <form onSubmit={handleSubmit} className="mt-8 grid grid-cols-6 gap-6 ">
                            ...
                            {/* <div className="col-span-6">
                                <label htmlFor="MarketingAccept" className="flex gap-4">
                                    <input
                                        type="checkbox"
                                        id="MarketingAccept"
                                        name="marketing_accept" onChange={handleChange}
                                        className="size-5 rounded-md border-slate-400 border-2 bg-white shadow-lg"
                                    />
                            ...
                            <div className="col-span-6">
                                <p className="text-sm text-gray-500">
                                    ...
                                    <a href="/terms-and-conditions" className="text-gray-700 underline"> terms and conditions </a>
                                    and
