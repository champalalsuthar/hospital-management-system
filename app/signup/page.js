    ...
    return (
        <PrivateRoutelogin>
            <section className="bg-gray-300 ">
                ...
                <div className="lg:grid lg:min-h-screen lg:grid-cols-12 text-center">
                    ...
                    >
                        <div className="max-w-xl lg:max-w-3xl mt-8">
                            ...
                            <form onSubmit={handleSubmit} className="mt-8 grid grid-cols-6 gap-6 ">
                                ...
                                <div className="col-span-6 sm:col-span-3">
                                    ...
                                    <input
                                        ...
                                        className="mt-1 p-2 w-full rounded-md border-slate-400 border-2	  bg-white text-sm text-gray-700 shadow-lg outline-none"
                                    />
                                </div>
                                ...
                                <div className="col-span-6 sm:col-span-3 ">
                                    ...
                                    <div className="flex justify-center items-center gap-1 relative ">
                                        <input
                                            ...
                                            className="mt-1 p-2  w-full rounded-md border-slate-400 border-2 bg-white text-sm text-gray-700 shadow-lg outline-none"
                                        />
                                        <div type="button" onClick={() => setShowConfirmPassword(!showConfirmPassword)} className='text-[22px] absolute top-50% right-2'>
                                ...
                                <div className="col-span-6 ">
                                    <label htmlFor="MarketingAccept" className="flex justify-center gap-1">
                                        <input
                                            type="checkbox"
                                            id="MarketingAccept"
                                            name="marketing_accept"
                                            onChange={handleChange}
                                            className="rounded-md border-slate-400 border-2 bg-white shadow-lg"
                                        />
                                        <div className="text-[13px] text-gray-700 ">
                                            I want to receive emails about hospital events, health updates, and announcements.
                                        </div>
                                    </label>
                                </div >
