...
const Footer = () => {
    ...
    return (
        ...
        <footer className="bg-gray-300 ">
            <div className="mx-auto w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
                <div
                ...
                <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
                    <div className="text-center sm:text-left">
                        ...
                        <ul className="mt-8 space-y-4 text-sm">
                            <li>
                                <a className="text-gray-700 transition hover:text-gray-700/75" href="/contactus"> Contact Us </a>
                            </li>
                            {/* <li>
...
{/* 
                    ...
                    <div className="text-center sm:text-left">
                        ...
                        <ul className="mt-8 space-y-4 text-sm">
                            {servicesData.map((services) => (
                                <li key={services._id}>
                                    <a className="text-gray-700 transition hover:text-gray-700/75" href={`/services/${services._id}`}>
                                        {services.name}
                                    </a>
                                </li>
                            ))}
                    ...
                    <div className="text-center sm:text-left">
                        ...
                        <ul className="mt-8 space-y-4 text-sm">
                            ...
                            <li>
                                <a className="text-gray-700 transition hover:text-gray-700/75" href="/appointment"> book Appointment </a>
                            </li>
                            <li>
                                <a className="text-gray-700 transition hover:text-gray-700/75" href="/faq"> FAQs </a>
                            </li>
                            <li>
                                <a className="text-gray-700 transition hover:text-gray-700/75" href="/legalsupport"> Legal Support </a>
                            </li>
                ...
                <div className="mt-16">
                    ...
                    <div className="mt-16 sm:flex sm:items-center sm:justify-between">
                        <div className="flex font-extrabold text-4xl underline justify-center text-teal-600 sm:justify-start">
                            RK Clinic+
                        </div>
