                ...
                <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div className="text-center sm:text-left">
                        ...
                        <ul className="mt-8 space-y-4 text-sm">
                            ...
                            <li>
                                <a className="text-gray-700 transition hover:text-gray-700/75" href="/services"> Restorative Dentistry </a>
                            </li>

                            <li>
                                <a className="text-gray-700 transition hover:text-gray-700/75" href="/services">Cosmetic Dentistry </a>
                            </li>

                            <li>
                                <a className="text-gray-700 transition hover:text-gray-700/75" href="/services"> Oral Surgery </a>
                            </li>
                        </ul>
                    </div>
                    <div className="text-center sm:text-left">
